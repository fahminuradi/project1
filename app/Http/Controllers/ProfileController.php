...
class ProfileController extends Controller
{
    ...
    public function show($id)
    {
        ...
        ->leftJoin('jadwals', 'profiles.id', '=', 'jadwals.profile_id')
        ->select('profiles.*', 'jadwals.mapel1','jadwals.mapel2','jadwals.mapel3','jadwals.mapel4','jadwals.mapel5','jadwals.guru1','jadwals.guru2','jadwals.guru3','jadwals.guru4','jadwals.guru5','grades.kelas','grades.jurusan')
        ->where('profiles.id', '=', $id)
        ->get();
